  ...
  const handleSaveCotizacion = async () => {
    ...
    try {
      ...
      const cotizacionData = {
        ...
        transportes: transportes.map(tr => ({ tipo_transporte: tr.tipo_transporte, proveedor: tr.proveedor || '', origen: tr.origen || destinoData.origen, destino: tr.destino || destinoData.destino, fecha_servicio: destinoData.fecha_salida, num_pasajeros: tr.capacidad_pasajeros, num_dias: 1, costo_total: tr.costo_total, precio_venta_total: tr.precio_venta_total, comision_transporte: tr.comision_transporte, utilidad: tr.comision_transporte, notas: tr.descripcion })),
